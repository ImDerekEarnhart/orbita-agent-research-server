...
class DiscoveryGenomeClient:
    ...
    def _request(self, method: str, path: str, payload: dict[str, Any] | None = None) -> dict[str, Any]:
        ...
        try:
            ...
            try:
                detail = json.loads(exc.read().decode("utf-8")).get("error", "request rejected")
            except Exception:
    ...
    def freeze_operator(
        ...
        *,
        ...
        result = self._request("POST", f"/operators/{quote(operator_id, safe='')}/freeze", {})
    ...
    def freeze_tournament(
        ...
        *,
        ...
        result = self._request("POST", f"/tournaments/{quote(tournament_id, safe='')}/freeze", {})
